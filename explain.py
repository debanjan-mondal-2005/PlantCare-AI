...
def generate_disease_explanation(disease_name: str) -> dict:
    ...
    if GEMINI_API_KEY:
        prompt = f'''
        You are an expert agricultural scientist. Provide a detailed, structured analysis 
        for the plant disease: "{disease_name}".
        Provide the response strictly in JSON format with the following schema:
        {{
            "disease": (string),
            "description": (string),
        ...
        Keep the tone informative and helpful for a farmer.
        '''
